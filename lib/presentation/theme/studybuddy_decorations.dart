...
class StudyBuddyDecorations {
  ...
  static BoxDecoration cardDecoration = BoxDecoration(
    ...
    border: Border.all(color: StudyBuddyColors.border, width: 1),
  );
  ...
  static BoxDecoration cardDecorationSelected = BoxDecoration(
    color: StudyBuddyColors.cardBackground,
    borderRadius: borderRadiusL,
    border: Border.all(color: StudyBuddyColors.primary, width: 2),
  );
  ...
  static BoxDecoration cardDecorationWarning = BoxDecoration(
    ...
    border: Border.fromBorderSide(
      BorderSide(color: StudyBuddyColors.warning, width: 3),
    ),
  );
  ...
  static BoxDecoration cardDecorationSuccess = BoxDecoration(
    ...
    borderRadius: borderRadiusL,
    border: Border.fromBorderSide(
      BorderSide(color: StudyBuddyColors.success, width: 3),
    ),
  );
  ...
  static BoxDecoration cardDecorationElevated = BoxDecoration(
    ...
    borderRadius: borderRadiusL,
    border: Border.all(color: StudyBuddyColors.borderLight, width: 1),
    boxShadow: [
      BoxShadow(
  ...
  static BoxDecoration outlineButton = BoxDecoration(
    ...
    borderRadius: borderRadiusFull,
    border: Border.all(color: StudyBuddyColors.textSecondary, width: 1),
  );
  ...
  static InputDecoration inputDecoration({
    ...
    return InputDecoration(
      ...
      border: OutlineInputBorder(
        borderRadius: borderRadiusFull,
        borderSide: const BorderSide(color: StudyBuddyColors.border, width: 1),
      ),
      ...
      errorBorder: OutlineInputBorder(
        borderRadius: borderRadiusFull,
        borderSide: const BorderSide(color: StudyBuddyColors.error, width: 1),
      ),
    );
  }
